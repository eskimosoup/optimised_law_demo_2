module Optimadmin
  ...
  private
    ...
    def service_params
      params.require(:service).permit(:department_id, :parent_id, :name, :image, :remove_image, :remote_image_url, :image_cache, :summary, :content, :slug, :suggested_url, :display, service_ids: [])
    end
  end
end
